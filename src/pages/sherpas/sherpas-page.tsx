    ...
    <>
      ...
      <section className="grid grid-cols-8 h-full">
        <div
          className={
            selectedUser
              ? 'col-span-6 h-full flex flex-col justify-between'
              : 'col-span-8 h-full flex flex-col justify-between'
          }
        >
          <ul className="flex flex-row flex-wrap gap-2 items-start justify-start h-fit">
            {isLoading
              ? Array.of(20).map((_, index) => (
                  <li key={index} className="w-60">
                    <div className="p-2 flex flex-row flex-nowrap gap-4 font-medium rounded-full bg-gray-50 items-center h-10 animate-pulse"></div>
                  </li>
                ))
        ...
        {selectedUser ? (
          <>
            <aside className="col-span-2 bg-gray-50 rounded animate-fadeIn">
              <header
                style={{
              ...
              >
                ...
                <div className="relative w-fit z-20 border border-white rounded-full">
                  ...
                  />
                  <Link
                    to={EDIT_SHERPA_PAGE_URL.replace(
                      ':id',
                      selectedUser?.id || ''
                    )}
              ...
              <div className="p-8 flex flex-col space-y-2">
                <UserDetailItem
                  ...
                  icon={
                    <IconId stroke={2} className="text-green-600 w-7 h-7" />
                  }
                />
                <UserDetailItem
                  label="Email"
                ...
                <UserDetailItem
                  ...
                  icon={
                    <IconCake stroke={2} className="text-orange-600 w-7 h-7" />
                  }
                />
                <UserDetailItem
                  label="Address"
                  ...
                  icon={
                    <IconMapPin stroke={2} className="text-blue-600 w-7 h-7" />
                  }
                />
                <UserDetailItem
